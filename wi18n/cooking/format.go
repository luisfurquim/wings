...
// the built-in table.
func (cv CookingVolume) Format(locale, formatName string) (string, error) {
	unitName := formatName
	if unitName == "" {
...
func (cw CookingWeight) Format(locale, formatName string) (string, error) {
	unitName := formatName
	if unitName == "" {
...
var _ wi18n.Numerical = CookingVolume{}
var _ wi18n.Numerical = CookingWeight{}
